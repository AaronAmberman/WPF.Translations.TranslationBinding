...
# Basic Usage
This is not a MS package natively included in WPF so after you add the [Nuget package reference](https://www.nuget.org/packages/WPF.Translations.TranslationBinding/) to your project/solution, you'll need to add a namespace declaration at the top of your XAML file...
